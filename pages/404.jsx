            ...
            <div className='bg-white mt-16 w-full flex flex-col pt-32 justify-center items-center'>
                <ConstantWideLayout>
                    ...
                    <div className='mt-10 flex justify-center'>
                        <Link className="mx-2 px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 hover:text-white text-white font-semibold" href={`/`} >Go to Home</Link>
                        <Link className="px-4 py-2 rounded-lg bg-indigo-100 text-indigo-600 mx-2 font-semibold" href={`/contact`} >Contact Us</Link>
                    </div>
